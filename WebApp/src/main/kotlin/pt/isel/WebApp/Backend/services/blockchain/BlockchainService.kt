...
fun deployContract() = pt.isel.WebApp.Backend.services.blockchain.wrappers.ExchangeHolder.deploy(
    web3j,
    CREDENTIALS,
    pt.isel.WebApp.Backend.services.blockchain.wrappers.ExchangeHolder.GAS_PRICE,
    pt.isel.WebApp.Backend.services.blockchain.wrappers.ExchangeHolder.GAS_LIMIT
).send().contractAddress


fun loadContract(address: String?) = pt.isel.WebApp.Backend.services.blockchain.wrappers.ExchangeHolder
    .load(
        address,
        web3j,
        CREDENTIALS,
